...
它以 [CoreCoder](https://github.com/he-yufeng/CoreCoder) 的紧凑架构为基础，在上面补齐了一条更完整的能力生命周期：
...
很多 Coding Agent 可以完成一次任务，但很难把这次执行过程沉淀成后续可复用的能力。CapWeaver 想探索的是一条更务实的路线：
